...
-Calculate correlations between each remaining feature to the response, classeUse spearman rank based correlation because classe is a factor.
...
#Cross validation with Random Forests Model
